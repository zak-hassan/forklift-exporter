...
public class HiveClient {
  ...
  public static void main(String[] args) throws SQLException {
    ...
    // "hiveuser", "");
    Connection con =
        DriverManager.getConnection("jdbc:hive2://hadoopmaster:10000/default", "hiveuser", "");
    Statement stmt = con.createStatement();

    String tableName = "empdata";
    stmt.executeQuery("drop table " + tableName);
    ResultSet res =
        stmt.executeQuery("create table " + tableName + " (id int, name string, dept string)");
